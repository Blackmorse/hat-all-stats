...
class ChppService @Inject() () {
  ...
  def getDivisionLevelAndLeagueUnit(team: Team, season: Int): ZIO[ChppClient & Client & AuthConfig & ClickhousePool & RestClickhouseDAO & LeagueInfoServiceZIO, HattidError, (Int, Long)] = {
    for {
