...
class LeagueController @Inject() (val controllerComponents: ControllerComponents,
                                  ...
                                  val viewDataFactory: ViewDataFactory) extends BaseController with I18nSupport {
  ...
  private def stats[T](leagueId: Int,
    ...
    val ss = messagesApi.preferred(request)

    Lang.apply("en")


    val messages = messagesApi.preferred(Seq(Lang.apply("en")))
  ...
  def bestLeagueUnits(leagueId: Int, statisticsParametersOpt: Option[StatisticsParameters]) =
    stats(leagueId = leagueId,
      ...
      viewFunc = {viewData: web.ViewData[LeagueUnitRating, WebLeagueDetails] => messages => views.html.league.bestLeagueUnits(viewData)}
    )
  ...
  def playerStats(leagueId: Int, statisticsParametersOpt: Option[StatisticsParameters]) =
    stats(leagueId = leagueId,
      ...
      viewFunc = {viewData: web.ViewData[PlayerStats, WebLeagueDetails] => messages => views.html.league.playerStats(viewData)}
    )
  ...
  def teamState(leagueId: Int, statisticsParametersOpt: Option[StatisticsParameters]) =
    stats(leagueId = leagueId,
      ...
      viewFunc = {viewData: web.ViewData[TeamState, WebLeagueDetails] => messages => views.html.league.teamState(viewData)})
  ...
  def playerState(leagueId: Int, statisticsParametersOpt: Option[StatisticsParameters]) =
    stats(leagueId = leagueId,
      ...
      viewFunc = {viewData: web.ViewData[PlayersState, WebLeagueDetails] => messages =>views.html.league.playerState(viewData)}
    )
  ...
  def formalTeamStats(leagueId: Int, statisticsParametersOpt: Option[StatisticsParameters]) =
    stats(leagueId = leagueId,
      ...
      viewFunc = {viewData: web.ViewData[FormalTeamStats, WebLeagueDetails] => messages => views.html.league.formalTeamStats(viewData)}
    )
