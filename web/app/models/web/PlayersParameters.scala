...
object PlayersParameters {
  implicit def queryStringBindable(implicit stringBuilder: QueryStringBindable[String]): QueryStringBindable[PlayersParameters]
      = new QueryStringBindable[PlayersParameters] {
