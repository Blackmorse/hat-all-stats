...
import com.blackmorse.hattid.web.databases.requests.{OrderingKeyPath, ClickhouseRequest}
import com.blackmorse.hattid.web.models.web.{Accumulate, Asc, PlayersParameters, RestStatisticsParameters}
import zio.test.ZIOSpecDefault
import com.blackmorse.hattid.web.StringExt

object PlayerGamesGoalsRequestSpec extends ZIOSpecDefault:
  def spec = suite("PlayerGamesGoalsRequest")(
