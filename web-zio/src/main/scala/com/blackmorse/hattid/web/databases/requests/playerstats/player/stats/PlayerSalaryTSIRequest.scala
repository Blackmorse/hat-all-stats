...
import com.blackmorse.hattid.web.databases.requests.model.player.PlayerSalaryTSI
import com.blackmorse.hattid.web.databases.requests.{ClickhouseRequest, OrderingKeyPath}
import com.blackmorse.hattid.web.models.web.{PlayersParameters, RestStatisticsParameters}
import sqlbuilder.{Select, SqlBuilder}

object PlayerSalaryTSIRequest extends ClickhousePlayerStatsRequest[PlayerSalaryTSI] {
