...
object MatchAttendanceOverview {
  implicit val jsonEncoder: JsonEncoder[MatchAttendanceOverview] = DeriveJsonEncoder.gen[MatchAttendanceOverview]

  val mapper: RowParser[MatchAttendanceOverview] = {
    get[Int]("league_id") ~
