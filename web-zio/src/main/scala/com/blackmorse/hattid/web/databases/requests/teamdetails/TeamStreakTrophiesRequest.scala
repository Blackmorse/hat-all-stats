...
import com.blackmorse.hattid.web.databases.requests.model.team.TeamStreakTrophies
import com.blackmorse.hattid.web.models.web.{Asc, Desc, RestStatisticsParameters, Round, SortingDirection}
