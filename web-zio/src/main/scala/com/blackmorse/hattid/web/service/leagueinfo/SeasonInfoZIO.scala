...
import com.blackmorse.hattid.web.models.web.NotFoundError
import com.blackmorse.hattid.web.service.leagueinfo.LeagueInfoServiceZIO.{Season, Round, DivisionLevel}
