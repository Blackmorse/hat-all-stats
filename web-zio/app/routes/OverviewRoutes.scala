...
import controllers.{WorldData, WorldLoadingInfo}
...
import hattid.zio.{DBServices, intParam, intParamOpt}
...
object OverviewRoutes {
  ...
  val routes: Seq[Route[DBServices & LeagueInfoServiceZIO & RestOverviewStatsService, HattidError]] = Seq(
