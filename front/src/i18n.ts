...
const resources = {
  en: {
    translation: {
      ...
      "menu.team_cards": "Yellow/Red cards",
      "menu.player_salary_tsi": "Salary/TSI",
      "menu.team_salary_tsi": "Salary/TSI",
      "menu.player_ratings": "Ratings",
      "menu.team_ratings": "Ratings",
      "menu.player_injuries": "Injuries",
      "menu.teams": "Teams",
      "menu.players": "Players",
      "menu.leagues": "Leagues",
      "menu.team_age_injury": "Age/Injuries",
  ...
  ru: {
    translation: {
      ...
      "menu.team_cards": "Желтые/Красные карточки",
      "menu.player_salary_tsi": "Зарплата/TSI",
      "menu.team_salary_tsi": "Зарплата/TSI",
      "menu.player_ratings": "Рейтинги",
      "menu.team_ratings": "Рейтинги",
      "menu.player_injuries": "Травмы",
      "menu.teams": "Команды",
      "menu.players": "Игроки",
      "menu.leagues": "Лиги",
      "menu.team_age_injury": "Возраст/Травмы",
