...
object CommonData {
  ...
  lazy val higherLeagueMap: Map[Int, CommonLeagueUnitInfo] = {
    Map(
      ...
      172 -> CommonLeagueUnitInfo(268241, "I.1"),
      173 -> CommonLeagueUnitInfo(268262, "I.1"),
      1000 -> CommonLeagueUnitInfo(256687, "I.1"),
      1001 -> CommonLeagueUnitInfo(258900, "I.1"),
      1002 -> CommonLeagueUnitInfo(260265, "I.1"),
      175 -> CommonLeagueUnitInfo(268496, "I.1"),
      174 -> CommonLeagueUnitInfo(268411, "I.1"),
      176 -> CommonLeagueUnitInfo(269093, "I.1"),
      177 -> CommonLeagueUnitInfo(269178, "I.1"),
      1003 -> CommonLeagueUnitInfo(266599, "I.1"),
      3000 -> CommonLeagueUnitInfo(269264, "I.1")
    )
  }
